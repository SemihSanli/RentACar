...
namespace CQRS_MediatR_RentACar.DataAccessLayer.Migrations
{
    ...
    [Migration("20250826141823_mig_location")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CQRS_MediatR_RentACar.EntityLayer.Airport", b =>
                {
            ...
            modelBuilder.Entity("CQRS_MediatR_RentACar.EntityLayer.CarRecommendationAI", b =>
                {
                    b.Property<int>("CarRecommendationAIID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("CarRecommendationAIID"));

                    b.Property<string>("AIResponse1")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("AIResponse2")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("AIResponse3")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasKey("CarRecommendationAIID");

                    b.ToTable("CarRecommendationAIs");
                });
            ...
            modelBuilder.Entity("CQRS_MediatR_RentACar.EntityLayer.Location", b =>
                {
