...
{
    public class EfCarRecommendationAIDal:GenericRepository<CarRecommendationAI>,ICarRecommendationAIDal
    {
        public EfCarRecommendationAIDal(CQRSMediatRDbContext context) : base(context)
        {
